export default function Prose({ children }: { children: any }) {
  return (
    <div className="smax-w-5xl rounded-lg bg-transparent py-10 transition-colors duration-500 sm:mx-auto sm:rounded-lg sm:shadow-lg sm:dark:shadow-sm md:max-w-6xl md:bg-white/30 md:dark:bg-nord-0/30">
